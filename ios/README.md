...
**Need it on phones fast?** See [Quick Device Deploy](QUICK_DEVICE_DEPLOY.md) for cable-run, SideStore/Ad-hoc, and TestFlight shortcuts (optimized for two devices).
